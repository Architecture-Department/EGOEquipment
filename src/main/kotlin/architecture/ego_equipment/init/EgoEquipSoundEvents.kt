...
object EgoEquipSoundEvents {
	val REGISTRY: DeferredRegister<SoundEvent> = EgoEquipUtil.modRegister(BuiltInRegistries.SOUND_EVENT)
	...
	private fun registerForHolder(id: String, zhName: String, location: String): DeferredHolder<SoundEvent, SoundEvent> {
		val register =
			REGISTRY.register(id) { -> SoundEvent.createVariableRangeEvent(EgoEquipUtil.modRl(location)) }
