package architecture.ego_equipment.common.item.weapon.melee.mace;
...
public class MaceEgoWeaponItem extends MeleeEgoWeaponGeoItem {
	...
	public MaceEgoWeaponItem(Properties itemProperties, IMeleeEgoWeaponItem.Builder egoWeaponBuilder, ResourceLocation modPath) {
