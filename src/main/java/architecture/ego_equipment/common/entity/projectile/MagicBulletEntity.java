...
public class MagicBulletEntity extends architecture.goldenboughs_lib.common.entiy.projectile.BulletEntity {
	...
	public MagicBulletEntity(EntityType<? extends architecture.goldenboughs_lib.common.entiy.projectile.BulletEntity> entityType, Level level) {
		super(entityType, level);
		this.setNoGravity(true);
	}

	public MagicBulletEntity(Level level, LivingEntity shooter) {
		super(EGOEquipmentProjectileEntityTypes.MAGIC_BULLET_ENTITY.get(), shooter, level);
		this.setNoGravity(true);
	}
