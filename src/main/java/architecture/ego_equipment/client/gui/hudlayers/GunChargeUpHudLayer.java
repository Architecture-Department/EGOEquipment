...
public class GunChargeUpHudLayer extends BasicHudLayer {
	...
	public static final ResourceLocation REMOTE_BOTTOM = EGOEquipment.modRl("hud_bar/remote_bottom");
	public static final ResourceLocation REMOTE_GUN = EGOEquipment.modRl("hud_bar/remote_gun");
	public static final ResourceLocation REMOTE_MAGIC_BULLET = EGOEquipment.modRl("hud_bar/remote_magic_bullet");

	public static final ResourceLocation BIG_REMOTE_BOTTOM = EGOEquipment.modRl("hud_bar/big_remote_bottom");
	public static final ResourceLocation BIG_REMOTE_GUN = EGOEquipment.modRl("hud_bar/big_remote_gun");
	public static final ResourceLocation BIG_REMOTE_MAGIC_BULLET = EGOEquipment.modRl("hud_bar/big_remote_magic_bullet");
