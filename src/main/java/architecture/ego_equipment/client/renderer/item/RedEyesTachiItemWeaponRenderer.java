...
public class RedEyesTachiItemWeaponRenderer extends GeoItemRendererExpand<RedEyesTachiItem> {
	public static final @NotNull ResourceLocation GLOWMASK_TEXTURE = EGOEquipment.modRl("textures/geo/item/weapon/red_eyes_tachi_glowmask.png");
	public static final @NotNull ResourceLocation GEO_HUNTIOG_TEXTURE = EGOEquipment.modRl("textures/geo/item/weapon/red_eyes_tachi_hunting.png");
	public static final @NotNull ResourceLocation HUNTIOG_TEXTURE = EGOEquipment.modRl("textures/item/weapon/red_eyes_tachi_hunting.png");
