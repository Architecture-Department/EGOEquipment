...
public final class ParticleProvidersRegistry {
	...
	public static void registry(RegisterParticleProvidersEvent event) {
		event.registerSpriteSet(EGOEquipmentParticleTypes.DYEING_MAGIC_CIRCLE.get(), DyeingMagicCircleParticle.Provider::new);
		event.registerSpriteSet(EGOEquipmentParticleTypes.MAGIC_BULLET_MAGIC_CIRCLE.get(), MagicBulletMagicCircleParticle.Provider::new);
		event.registerSpriteSet(EGOEquipmentParticleTypes.SOLEMN_LAMENT_BUTTERFLY_BLACK.get(), ButterflyParticle.Provider::new);
		event.registerSpriteSet(EGOEquipmentParticleTypes.SOLEMN_LAMENT_BUTTERFLY_WHITE.get(), ButterflyParticle.Provider::new);
	}
}
