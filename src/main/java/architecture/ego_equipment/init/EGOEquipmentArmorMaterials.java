...
public final class EGOEquipmentArmorMaterials {
	public static final DeferredRegister<ArmorMaterial> REGISTRY = EGOEquipment.modRegister(BuiltInRegistries.ARMOR_MATERIAL);
	...
	private static @NotNull Holder<ArmorMaterial> register(String id, EnumMap<ArmorItem.Type, Integer> defense, int enchantmentValue,
		...
		return REGISTRY.register(id, () -> new ArmorMaterial(enummap, enchantmentValue, equipSound, repairIngridient, layers, toughness,
			knockbackResistance));
	}
}
